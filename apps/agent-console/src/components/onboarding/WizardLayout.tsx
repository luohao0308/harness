...
export function WizardLayout({
  ...
  return (
    <div className={cn("flex min-h-screen flex-col bg-slate-50", className)}>
      ...
      <header
        className="border-b border-slate-200 bg-white px-4 py-4 shadow-sm sm:px-6 lg:px-8"
        role="banner"
      >
      ...
      <main className="flex-1 px-4 py-8 sm:px-6 lg:px-8" role="main">
        <div className="mx-auto max-w-4xl">
          <div
            className={cn(
              "rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 sm:p-8",
              {
                "animate-slide-in-right": isAnimating && direction === "forward",
                "animate-slide-in-left": isAnimating && direction === "backward",
              },
            )}
            key={currentStep}
          >
      ...
      {/* Navigation Buttons */}
      <footer
        className="border-t border-slate-200 bg-white px-4 py-4 sm:px-6 lg:px-8"
        role="contentinfo"
      >
        <div className="mx-auto max-w-4xl">
          <NavigationButtons
