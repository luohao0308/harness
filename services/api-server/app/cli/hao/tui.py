...
class HaoApp(App):
    TITLE = "hao"
    SUB_TITLE = "Claude Code-style local Agent CLI"
    CSS = """
    ...
    def _release_notes_text(self) -> str:
        return "\n".join(
            (
                ...
                "v4.3: Claude Code-style footer shows model strength, compact ring, "
                "style, approvals, and commands.",
                "v4.3: /compress aliases /compact for local active-path context summarization.",
                "v4.2: inline Claude Code-style terminal page; no fullscreen editor screen.",
    ...
    def _backend_mode_for_interaction(self, interaction_mode: str) -> str:
        return "codex_plan" if interaction_mode == "plan" else "cli_agent"
