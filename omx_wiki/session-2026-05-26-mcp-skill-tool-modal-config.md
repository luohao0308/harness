...
- XML-triggered MCP execution stays scoped to already attached Agent capabilities. Unknown or unattached tool names still use the existing failed-tool feedback path, and Harness Agent plan mode does not gain a new direct MCP execution bypass.
