...
4. `tail.state === "done"`；
5. `tail.metadata.workspace_mode === "plan" || tail.metadata.workspace_mode === "markdown_plan"`；
...
export type PlanApprovalPanelProps = {
  ...
  onApprove: () => void;
  /** 修改规划 → setDraft(planNode.content) + focus composer + setWorkspaceMode("markdown_plan") */
  onEdit: () => void;
