...
1. Read this file.
2. Read `docs/ai/task-progress.yaml` for machine progress.
...
| Purpose | Path |
| --- | --- |
| Module → docs map | `docs/MODULE-INDEX.md` |
| Feature → spec map | `docs/SPEC-INDEX.md` |
| Known errors & fixes | `docs/ai/error-registry.md` |
| Design anti-patterns | `docs/ai/anti-patterns.md` |
