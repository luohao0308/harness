...
| 导入 OpenAPI | 官网、`docs/contracts/api` | Swagger、Apifox、Postman 导入 |
| 下载中文契约 | 官网、`docs/contracts/api` | 获取中文 JSON/YAML |
...
| 中文 OpenAPI JSON/YAML | 已落地 | `docs/contracts/api` 与官网 public |
| 控制台任务入口 | 已落地 | `/tasks` |
...
- 官网公开 JSON/YAML 与 `docs/contracts/api` 保持一致。
