...
| Subagent 长上下文与产物 | worker 已执行 assignment 工具、多轮 `next_tools` ReAct 工具规划并回写结果，长上下文压缩和结构化产物仍需增强 | `docs/human/features/04-subagent-orchestration.md` |
...
2. 补 Subagent worker 长上下文压缩和结果产物详情
