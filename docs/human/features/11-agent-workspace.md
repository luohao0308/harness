...
Agent Workspace 是 AI Harness Platform 的主使用入口。下一代形态是 Workspace Pro：在现有 `/agents/:agentId/workspace` 路由上升级出 Cursor / Workspace artifacts / Windsurf 式三栏对话工作台，而不是另起独立产品。
