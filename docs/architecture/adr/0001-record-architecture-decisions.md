...
All architecture decisions are recorded in `docs/architecture/adr`. AI execution documents reference ADR decisions through `docs/development/ai/reference/architecture-and-decisions.md`.
