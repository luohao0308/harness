# Team Mode AionUi Parity Target

## Target Reset

The authoritative product target is `/Users/luohao/Downloads/AionUi-main` Team Mode plus the
visual reference `/Users/luohao/Downloads/AionUi.jpg`.
...
Team Mode product surface. The user-facing result must feel like AionUi Team Mode: a long-lived
...
message routing, wake behavior, and backend-visible semantics must match AionUi.

## Authoritative AionUi Sources

- UI shell and column layout: `/Users/luohao/Downloads/AionUi-main/src/renderer/pages/team/TeamPage.tsx`
- Agent tabs: `/Users/luohao/Downloads/AionUi-main/src/renderer/pages/team/components/TeamTabs.tsx`
- Column chat routing: `/Users/luohao/Downloads/AionUi-main/src/renderer/pages/team/components/TeamChatView.tsx`
- Session coordinator: `/Users/luohao/Downloads/AionUi-main/src/process/team/TeamSession.ts`
- Mailbox service: `/Users/luohao/Downloads/AionUi-main/src/process/team/Mailbox.ts`
- Wake/status engine: `/Users/luohao/Downloads/AionUi-main/src/process/team/TeammateManager.ts`
- Team tools: `/Users/luohao/Downloads/AionUi-main/src/process/team/mcp/team/TeamMcpServer.ts`
...
Harness must provide AionUi-equivalent native tools. Transport can be FastAPI/SSE/SQLAlchemy
...
- `team_task_list`: returns the same compact text board style as AionUi.
...
The first viewport must match AionUi's shape:

- Harness ConsoleShell left navigation remains, but the Team product area uses AionUi structure.
...
- Do not copy AionUi's Electron IPC/TCP MCP transport; copy its product semantics using Harness'
  native backend.
- Do not claim completion from API green checks alone. Visual and communication semantics must be
  verified against the AionUi source and screenshot.

## Execution Order

1. Lock this target and test spec before further broad edits.
2. Align the column composer and tabs with AionUi's column-is-target interaction.
3. Align backend mailbox/wake/status/tool semantics with the AionUi contracts above.
...
5. Verify with backend tests, frontend tests, Playwright desktop/mobile smoke, and screenshots
   compared against `/Users/luohao/Downloads/AionUi.jpg`.
