...
> 2026-08-10 起，机器进度以 [`development/ai/task-progress.yaml`](../../development/ai/task-progress.yaml) 为准，当前待办以 [`TASKS.md`](../../TASKS.md) 为准。
...
- Added one-page visual summary: `docs/工作日志/reports/langgraph-langchain-visual-summary-2026-06-03.html`.
...
- Added deployment/runbook notes in `docs/project-memory/runbooks/web-research.md`.
...
- Added Stage 07 stage doc: `docs/development/ai/stages/07-private-deployable-harness-chain.md`.
...
- `apps/agent-console/README.md`, `docs/工作日志/archive/task-progress-human.md`, `docs/development/ai/task-progress.yaml`, and `omx_wiki/project-handoff-current-state.md` distinguish quick smoke, release smoke, and live validation.
...
- Recovery path: `docs/project-memory/runbooks/migrations.md` records the knowledge restore verification contract, backed by automated restore smoke coverage.
