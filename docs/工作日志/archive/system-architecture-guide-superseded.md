...
> 状态：superseded。当前架构以 [`architecture/system-architecture-spec.md`](../../architecture/system-architecture-spec.md) 和 [`architecture/SYSTEM.md`](../../architecture/SYSTEM.md) 为准。
