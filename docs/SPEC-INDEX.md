...
| 计划与执行 | [02 Planner 与 Executor](./human/features/02-planner-executor.md) | [OpenAPI](./api/openapi.yaml) | [运行时 Agent Prompts](./ai/reference/runtime-agent-prompts.md)、[Tool Registry](./ai/reference/tool-registry-spec.md) | [前端规格](./ai/reference/frontend-spec.md) | [QA 策略](./qa/test-strategy.md) | 基础落地 |
...
| Replay 与恢复 | [03 Event Sourcing 与 Replay](./human/features/03-event-sourcing-replay.md) | [OpenAPI](./api/openapi.yaml) | [数据库 ERD 与迁移规则](./ai/reference/database-erd-migrations.md) | [前端规格](./ai/reference/frontend-spec.md) | [QA 策略](./qa/test-strategy.md) | 基础落地 |
...
| 工具执行 | [06 模型与工具审计](./human/features/06-model-tool-audit.md) | [OpenAPI](./api/openapi.yaml) | [Tool Registry YAML](./ai/reference/tool-registry.yaml)、[安全策略矩阵](./ai/reference/security-policy-matrix.md) | [前端规格](./ai/reference/frontend-spec.md) | [安全威胁模型](./security/threat-model.md) | 基础落地 |
| 模型调用审计 | [06 模型与工具审计](./human/features/06-model-tool-audit.md) | [OpenAPI](./api/openapi.yaml) | [运行时 Agent Prompts](./ai/reference/runtime-agent-prompts.md)、[数据库 Schema](./ai/reference/database-schema.yaml) | [前端规格](./ai/reference/frontend-spec.md) | [QA 策略](./qa/test-strategy.md) | 基础落地 |
| 工具调用审计 | [06 模型与工具审计](./human/features/06-model-tool-audit.md) | [OpenAPI](./api/openapi.yaml) | [Tool Registry](./ai/reference/tool-registry-spec.md)、[安全策略矩阵](./ai/reference/security-policy-matrix.md) | [前端规格](./ai/reference/frontend-spec.md) | [安全威胁模型](./security/threat-model.md) | 基础落地 |
