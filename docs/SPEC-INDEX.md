...
|---|---|---|---|---|---|---|
| 平台架构方向 | [System Architecture](./01-system-architecture.md)、[产品规格](./00-product-spec.md) | [API 规格](./03-api-spec.md)、[OpenAPI](./api/openapi.yaml) | [架构与技术决策](./ai/reference/architecture-and-decisions.md)、[运行时与部署规格](./ai/reference/runtime-deployment-spec.md) | [页面清单](./design/page-inventory.md) | [部署 Runbook](./runbooks/deployment.md)、[验证脚本](../scripts/validate-harness-flow.sh) | Stage 07 已关闭；Private Deployment Experience 已完成 |
